...
typedef jv (*jq_io_handle_register_scheme_f)(jq_state *, const char *, jq_hopen_f);
typedef jv (*jq_io_handle_open_f)(jq_state *, jv);
typedef jv (*jq_io_handle_close_f)(jq_state *, jv, jv);
typedef jv (*jq_io_handle_reset_f)(jq_state *, jv, jv);
typedef jv (*jq_io_handle_io_f)(jq_state *, jv, jv, jv);
typedef jv (*jq_io_handle_stat_f)(jq_state *, jv, jv);
...
struct jq_plugin_vtable {
  ...
  jq_io_handle_register_scheme_f jq_io_handle_register_scheme;
  jq_io_handle_open_f jq_io_handle_open;
  jq_io_handle_close_f jq_io_handle_close;
  jq_io_handle_reset_f jq_io_handle_reset;
  jq_io_handle_io_f jq_io_handle_io;
  jq_io_handle_stat_f jq_io_handle_stat;
...
#define jq_io_handle_register_scheme ((*(struct jq_plugin_vtable **)jq)->jq_io_handle_register_scheme)
#define jq_io_handle_open ((*(struct jq_plugin_vtable **)jq)->jq_io_handle_open)
#define jq_io_handle_close ((*(struct jq_plugin_vtable **)jq)->jq_io_handle_close)
#define jq_io_handle_reset ((*(struct jq_plugin_vtable **)jq)->jq_io_handle_reset)
#define jq_io_handle_io ((*(struct jq_plugin_vtable **)jq)->jq_io_handle_io)
#define jq_io_handle_stat ((*(struct jq_plugin_vtable **)jq)->jq_io_handle_stat)
#endif /* JQ_PLUGIN */
