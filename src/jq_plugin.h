...
typedef jv (*jq_io_register_scheme_f)(jq_state * jq, const char * scheme, jq_io_open_f jq_io_open);
typedef jv (*jq_io_open_handle_f)(jq_state *jq, jv uri);
typedef jv (*jq_io_handle_call_f)(jq_state *jq, jv input, jv method, jv handle);
typedef jv (*jq_io_handle_validate_f)(jv handle);
...
struct jq_plugin_vtable {
  ...
  jq_io_register_scheme_f  jq_io_register_scheme;
  jq_io_open_handle_f      jq_io_open_handle;
  jq_io_handle_call_f      jq_io_handle_call;
  jq_io_handle_validate_f  jq_io_handle_validate;
...
#define jq_io_register_scheme ((*(struct jq_plugin_vtable **)jq)->jq_io_register_scheme)
#define jq_io_open_handle ((*(struct jq_plugin_vtable **)jq)->jq_io_open_handle)
#define jq_io_handle_call ((*(struct jq_plugin_vtable **)jq)->jq_io_handle_call)
#define jq_io_handle_validate ((*(struct jq_plugin_vtable **)jq)->jq_io_handle_validate)
#endif /* JQ_PLUGIN */
