...
//   return jq_io_handle_close(jq, input);
// }
...
//   struct io_handle *h = jq_io_handle_get(jq, fh);
...
//   return jq_io_handle_new(jq, "FILE", &f_iovt, h);
// }
...
//   h->proc = proc;
//   h->spawnspec = spawnspec;
//   return jq_io_handle_new(jq, "PROCESS", &p_iovt, h);
// }
